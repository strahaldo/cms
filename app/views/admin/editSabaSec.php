<?php require VIEW_ROOT . '/templates/header.php'; ?>
  ...
  <div class="col-md-3">
  <form action="<?php echo BASE_URL ?>admin/editSabaSec.php" enctype="multipart/form-data" method="POST" autocomplete="off">
  ...
  <input type="hidden" name="s_id" value="<?php echo escape($s['s_id']); ?>">
